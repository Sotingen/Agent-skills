...
| SPA architecture and conventions     | [app-patterns.md](./references/app-patterns.md)                   |
| Component splitting strategies       | [component-granularity.md](./references/component-granularity.md) |
| Custom hooks and Facade pattern      | [custom-hooks.md](./references/custom-hooks.md)                   |
| TypeScript type safety patterns      | [typescript-safety.md](./references/typescript-safety.md)         |
...
Use [app-patterns.md](./references/app-patterns.md) when you need:

- Full SPA architecture conventions (React 19 + TypeScript + Vite)
- Data fetching patterns (React Query, service layers)
- Form patterns (react-hook-form, controlled components)
- State management strategy (when to use what)
- Routing and URL-driven modals
- Error handling (interceptors, boundaries)
- Testing and internationalization setup

### Component Granularity

Use [component-granularity.md](./references/component-granularity.md) when you need:

- When to split large components (~200+ lines)
- Extracting repeated UI blocks
- Form section extraction patterns
- Conditional rendering refactoring
- Props interface design (too many props smell)

### Custom Hooks

Use [custom-hooks.md](./references/custom-hooks.md) when you need:

- Extracting business logic from components (Facade pattern)
- Data fetching + mutation hook patterns
- Form logic hooks
- Naming conventions (`use<Entity>`, `use<Entity>Form`)
- Hook structure and organization

### TypeScript Safety

Use [typescript-safety.md](./references/typescript-safety.md) when you need:

- Props interface patterns
- Generic component typing
- Event handler types
- Form types with react-hook-form
- API request/response type separation
