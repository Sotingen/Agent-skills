...
├── api/           # React Query hooks wrapping service calls
...
├── lib/           # Pre-configured library instances (axios, queryClient)
├── services/      # Raw API calls by domain (productService, userService)
